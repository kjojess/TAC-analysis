...
Import data file
```{r message=FALSE, warning=FALSE}
TAC<-read.csv("2022-11-18 TAC linearity datafile .csv", na.strings=c("","NA"))
```
...
```{r message=FALSE, warning=FALSE}
TAC_NTC<-read.csv("2022-11-18 TAC linearity datafile .csv", na.strings=c("","NA"))
...
write.csv(summary,file="TAC_linearity_test_4_summary.csv")
```
